...
This document describes how the **AI WP Dynamic Cache Plugin** constructs, normalises, and hashes cache keys. A consistent, deterministic cache key strategy is critical for correct cache hits, correct purge targeting, and preventing cache poisoning.
